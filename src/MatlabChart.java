...
public class MatlabChart {
    ...
    private ArrayList<Boolean> lineTypes;  //true - czysto liniowy, false - tez punkty
    ...
    public MatlabChart() {
        ...
        lineTypes = new ArrayList<Boolean>();
    }

    public void plot(double[] x, double[] y, String spec, float lineWidth, String title, boolean lineType) {
    ...
    public void RenderPlot() {
        ...
        for (int i = 0; i < colors.size(); i++) {
            if (!lineTypes.get(i)){
                ...
                renderer.setSeriesShape(i, ShapeUtils.createRegularCross(3f, 3f));
                //renderer.setSeriesVisibleInLegend(i, false); - jezeli chcemy bez podpisu w legendzie "dane"
            }
            else {
            ...
            ((NumberAxis)plot.getDomainAxisForDataset(i)).setAutoRangeIncludesZero(false);
        }
